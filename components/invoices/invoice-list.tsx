...
export function InvoiceList() {
  ...
  if (isLoading)
    return <div className="p-4 text-center">Memuat daftar invoice...</div>;
              ...
              <TableRow key={inv.id} className="hover:bg-slate-50/50">
                ...
                <TableCell>
                  <div className="flex flex-col">
                    <span>
                      {format(new Date(inv.tanggal), "dd MMM yyyy", {
                        locale: idLocale,
                      })}
                    </span>
                    <span className="text-xs text-muted-foreground">
                      Jatuh tempo:{" "}
                      {format(new Date(inv.tanggalJatuhTempo), "dd MMM", {
                        locale: idLocale,
                      })}
                    </span>
                  </div>
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className={getStatusColor(inv.statusPembayaran)}
                  >
