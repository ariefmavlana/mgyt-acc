    ...
    return (
      <div className="space-y-3">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="h-16 w-full bg-slate-100 animate-pulse rounded-lg"
          />
        ))}
      </div>
    );
    ...
    return (
      <div className="text-center py-20 bg-white rounded-lg border border-dashed">
        ...
        <Button
          asChild
          variant="outline"
          className="mt-6 border-none underline text-orange-500 hover:text-orange-600"
        >
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50/50">
            ...
            <TableHead className="w-37.5">No. Transaksi</TableHead>
            <TableHead>Deskripsi</TableHead>
            <TableHead className="w-30">Tipe</TableHead>
            <TableHead className="text-right w-37.5">Nilai (IDR)</TableHead>
          ...
          {transactions.map((transaction) => (
            ...
            >
              ...
              <TableCell>
                <Badge
                  variant="outline"
                  className="font-normal capitalize bg-slate-50"
                >
