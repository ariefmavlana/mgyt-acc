      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Kelola data karyawan, kontrak, dan informasi penggajian.
          </p>
        </div>
      ...
      <Card>
        ...
        <CardContent className="p-0">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="w-75">Nama Karyawan</TableHead>
                ...
                employees.map((emp) => (
                  <TableRow key={emp.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          emp.status === "AKTIF" ? "default" : "secondary"
                        }
                      >
                        {emp.status}
                      </Badge>
                    ...
                    <TableCell>
                      {emp.tanggalMasuk
                        ? format(new Date(emp.tanggalMasuk), "dd MMM yyyy", {
                            locale: idLocale,
                          })
                        : "-"}
                    </TableCell>
